...
function DialogFooter({
  ...
  return (
    <div
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 border-t-2 border-dashed bg-secondary/55 p-4 sm:flex-row sm:justify-end",
        className,
      )}
